...
comparably limited. We demonstrate how to use the \proglang{R} package
...
and we will discuss many more interesting models in this paper.
...
such a model in \pkg{brms} without actually fitting the model.
...
\proglang{Stan}. We could have done this directly in the main formula
