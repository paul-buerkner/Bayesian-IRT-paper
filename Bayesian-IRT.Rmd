...
I will provide a review and comparison of these package later on in Section
\ref{comparison}.
...
The paper is structured as follows: In Section \ref{model}, I describe the
...
Section \ref{estimation}, I discuss how models are estimated and post-processed
before I continue with several hands-on examples in Section \ref{examples}.
I provide a comparison of IRT supporting \proglang{R} packages in
...
of the present paper. Accordingly, I focus on a set of seven widely applied and
...
packages are of high quality, user friendly, and well documented so I primarily
focus my comparison on the features they support. A high level overview of the
